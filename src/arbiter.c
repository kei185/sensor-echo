...
void dma_receive_complete_handler() { increment_lap(); }
void uart_transmit_complete_handler()
{
        static TxBufSlot* target = NULL;
        ...
        //  HAL_DMA_Start_IT(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t
